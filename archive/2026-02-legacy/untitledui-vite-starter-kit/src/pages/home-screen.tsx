        ...
        <div className="flex h-dvh flex-col">
            <div className="flex min-h-0 flex-1 flex-col items-center justify-center px-4">
                ...
                <div className="mt-6 flex items-center gap-3">
                    <Link
                        to="/vanyshr-ui"
                        className="inline-flex items-center justify-center gap-1 rounded-lg px-4 py-2.5 text-md font-semibold text-brand-secondary hover:text-brand-secondary_hover focus-visible:outline-2 focus-visible:outline-offset-2 outline-focus-ring"
                    >
                        Vanyshr UI
                    </Link>
